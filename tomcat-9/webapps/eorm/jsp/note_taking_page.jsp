...
<head>
    ...
    <link rel="stylesheet" href="style/change_u_info.css">
    ...
    <script src="script/tiny-jq.js"></script>
    ...
    <div id="header" style="width:100%;height:50px;">
        ...
        <div id="menu_button">
            ...
            <div id="pop_up_toggle">
                ...
                <div class="button-general level-1-3-button level-1-3-button-2 u_info" id="edit_u_pw">
                    <div class="level-1-3-button-title">
                ...
                <div class="button-general level-1-3-button level-1-3-button-2 u_info" id="edit_user_info_button">
                    <div class="level-1-3-button-title">
                ...
                <div class="button-general level-1-3-button level-1-3-button-2 u_info_ch " id="u_info_ch_return">
                    <div class="level-1-3-button-title">
                        <div>return</div>
                    </div>
                    <div class="icon">
                ...
                <div class="pop_up_toggle_u_info u_info_ch">
                    <div>Email</div>
                    <div><input type="text" value="${user.email}"/></div>
                </div>
                <div class="pop_up_toggle_u_info u_info_ch">
                    <div>Age</div>
                    <div><input type="text" value="${user.age}"/></div>
                </div>
                <div class="pop_up_toggle_u_info u_info_ch">
                    <div>Gender</div>
                    <div><input type="text" value="${user.genderName}"></div>
                </div>


                <div class="button-general level-1-3-button level-1-3-button-2 change_password_text_input_box u_info_ch">
                    <div class="level-1-3-button-title">
                        <div>change</div>
                    </div>
            ...
            <!--change Password-->
                ...
                <div class="button-general level-1-3-button level-1-3-button-2 u_info_ch_pw " id="u_info_ch_pw_return">
                    <div class="level-1-3-button-title">
                        <div>return</div>
                    </div>
                    <div class="icon">
                ...
                <div class="pop_up_toggle_u_info u_info_ch_pw">
                    <div>Password</div>
                ...
                <div class="button-general level-1-3-button level-1-3-button-2 change_password_text_input_box u_info_ch_pw">
                    <div class="level-1-3-button-title">
                        <div>change</div>
                    </div>
                ...
                <div class="button-general level-1-3-button level-1-3-button-2 change_password_text_input_box u_info u_info">
                    <div class="level-1-3-button-title">
                        <div>Logout</div>
                    </div>
                    <div class="icon">
...
-------------------------------------------------------------->
        ...
        <div id="note_body">
            <div id="opened_notes">
                ...
                <div id="date" class="title_div"></div><!--feb.18.2023-->
                <!-------------------------------------------------------------------------------->
            </div>
        ...
        <div id="notes" style="padding-bottom:40vh;">   
<!--            <div class="note">
